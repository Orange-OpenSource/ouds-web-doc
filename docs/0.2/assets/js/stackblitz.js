...
</html>`}function z(e,t){let n=B(e);n.action=E("/run",t),n.target=S(t),document.body.appendChild(n),n.submit(),document.body.removeChild(n)}function m(e){var n;return e!=null&&e.contentWindow?((n=R(e))!=null?n:new b(e)).pending:Promise.reject("Provided element is not an iframe.")}function J(e,t){z(e,t)}function X(e,t){let n=E(`/edit/${e}`,t),o=S(t);window.open(n,o)}function Y(e,t){let n=E(`/github/${e}`,t),o=S(t);window.open(n,o)}function Q(e,t,n){var c;let o=v(e),r=G(t,n),s=document.createElement("iframe");return _(o,s,n),(c=s.contentDocument)==null||c.write(r),m(s)}function Z(e,t,n){let o=v(e),r=document.createElement("iframe");return r.src=w(`/edit/${t}`,n),_(o,r,n),m(r)}function ee(e,t,n){let o=v(e),r=document.createElement("iframe");return r.src=w(`/github/${t}`,n),_(o,r,n),m(r)}var C={connect:m,embedGithubProject:ee,embedProject:Q,embedProjectId:Z,openGithubProject:Y,openProject:J,openProjectId:X};var L="https://cdn.jsdelivr.net/npm/@ouds/web@0.2.0/dist/css/ouds-web.min.css",x="0.2";var D="https://cdn.jsdelivr.net/npm/@ouds/web@0.2.0/dist/js/ouds-web.bundle.min.js",O=`(() => {
  // ns-hugo:/Users/zgrl8388/dev/ob1/Orange-Boosted-Bootstrap/site/assets/js/partials/snippets.js
