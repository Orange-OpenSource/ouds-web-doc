  ...
  <div class="text-input mb-medium">
    <div class="text-input-container text-input-container-outlined">
      <svg aria-hidden="true">
        <use xlink:href="/orange/docs/1.2/assets/img/ouds-web-sprite.svg#lock-closed"></use>
      </svg>
      ...
      <button class="btn btn-minimal btn-icon">
        <svg aria-hidden="true">
          <use xlink:href="/orange/docs/1.2/assets/img/ouds-web-sprite.svg#accessibility-vision"></use>
        </svg>
