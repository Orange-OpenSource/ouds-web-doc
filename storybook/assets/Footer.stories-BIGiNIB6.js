const s={title:"Components/Footer",parameters:{docs:{toc:!0}}},a=()=>`<div class="bd-example order-first m-none border-none p-none m-none border-none"> <footer class="footer navbar" data-bs-theme="dark">
  ...
  <div class="container-fluid container-max-width footer-service">
    <ul class="navbar-nav gap-large gap-md-2xlarge">
      <li><a class="nav-link gap-2xsmall" href="#"><svg width="1.875rem" height="1.875rem" aria-hidden="true"><use xlink:href="/orange/docs/1.2/assets/img/ouds-web-sprite.svg#location-pin-compass"></use></svg><span>Store locator</span></a></li>
      <li><a class="nav-link gap-2xsmall" href="#"><svg width="1.875rem" height="1.875rem" aria-hidden="true"><use xlink:href="/orange/docs/1.2/assets/img/ouds-web-sprite.svg#mobile-network-coverage"></use></svg><span>Coverage checker</span></a></li>
      <li><a class="nav-link gap-2xsmall" href="#"><svg width="1.875rem" height="1.875rem" aria-hidden="true"><use xlink:href="/orange/docs/1.2/assets/img/ouds-web-sprite.svg#live-chat"></use></svg><span>Contact us</span></a></li>
      <li><a class="nav-link gap-2xsmall" href="#"><svg width="1.875rem" height="1.875rem" aria-hidden="true"><use xlink:href="/orange/docs/1.2/assets/img/ouds-web-sprite.svg#child-protection"></use></svg><span>Child protection</span></a></li>
    </ul>
  </div>
  <div class="border-bottom border-thin border-default"></div>
