...
</html>`}function W(e,t){const n=C(e);n.action=b("/run",t),n.target=v(t),document.body.appendChild(n),n.submit(),document.body.removeChild(n)}function f(e){return e?.contentWindow?(q(e)??new U(e)).pending:Promise.reject("Provided element is not an iframe.")}function V(e,t){W(e,t)}function z(e,t){const n=b(`/edit/${e}`,t),o=v(t);window.open(n,o)}function K(e,t){const n=b(`/github/${e}`,t),o=v(t);window.open(n,o)}function G(e,t,n){const o=w(e),s=R(t,n),r=document.createElement("iframe");return E(o,r,n),r.contentDocument?.write(s),f(r)}function J(e,t,n){const o=w(e),s=document.createElement("iframe");return s.src=g(`/edit/${t}`,n),E(o,s,n),f(s)}function X(e,t,n){const o=w(e),s=document.createElement("iframe");return s.src=g(`/github/${t}`,n),E(o,s,n),f(s)}const Y={connect:f,embedGithubProject:X,embedProject:G,embedProjectId:J,openGithubProject:K,openProject:V,openProjectId:z},Q=`// NOTICE!!! Initially embedded in our docs this JavaScript
...
`,m={cssCdn:"https://cdn.jsdelivr.net/npm/@ouds/web-orange@1.0.0/dist/css/ouds-web.min.css",cssBootstrapCdn:"https://cdn.jsdelivr.net/npm/@ouds/web-orange@1.0.0/dist/css/ouds-web-bootstrap.min.css",jsBundleCdn:"https://cdn.jsdelivr.net/npm/@ouds/web-common@1.0.0/dist/js/ouds-web.bundle.min.js",docsVersion:"1.0"};document.querySelectorAll(".btn-edit").forEach(e=>{e.addEventListener("click",t=>{const n=t.target.closest(".bd-code-snippet"),o=n.querySelector(".bd-example"),s=o.innerHTML,r=n.querySelector(".btn-edit").getAttribute("data-sb-js-snippet"),i=n.closest("[data-sb-css-bootstrap]"),a=Array.from(o.classList).join(" ");Z(s,r,a,i)})});const Z=(e,t,n,o)=>{const s=`<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8">
