const P="https://stackblitz.com",S=["angular-cli","create-react-app","html","javascript","node","polymer","typescript","vue"],C=["project","search","ports","settings"],B=["light","dark"],x=["editor","preview"],_={clickToLoad:e=>d("ctl",e),devToolsHeight:e=>I("devtoolsheight",e),forceEmbedLayout:e=>d("embed",e),hideDevTools:e=>d("hidedevtools",e),hideExplorer:e=>d("hideExplorer",e),hideNavigation:e=>d("hideNavigation",e),openFile:e=>u("file",e),showSidebar:e=>L("showSidebar",e),sidebarView:e=>y("sidebarView",e,C),startScript:e=>u("startScript",e),terminalHeight:e=>I("terminalHeight",e),theme:e=>y("theme",e,B),view:e=>y("view",e,x),zenMode:e=>d("zenMode",e),organization:e=>`${u("orgName",e?.name)}&${u("orgProvider",e?.provider)}`,crossOriginIsolated:e=>d("corp",e)};function T(e={}){const t=Object.entries(e).map(([n,o])=>o!=null&&_.hasOwnProperty(n)?_[n](o):"").filter(Boolean);return t.length?`?${t.join("&")}`:""}function d(e,t){return t===!0?`${e}=1`:""}function L(e,t){return typeof t=="boolean"?`${e}=${t?"1":"0"}`:""}function I(e,t){if(typeof t=="number"&&!Number.isNaN(t)){const n=Math.min(100,Math.max(0,t));return`${e}=${encodeURIComponent(Math.round(n))}`}return""}function y(e,t="",n=[]){return n.includes(t)?`${e}=${encodeURIComponent(t)}`:""}function u(e,t){return(Array.isArray(t)?t:[t]).filter(o=>typeof o=="string"&&o.trim()!=="").map(o=>`${e}=${encodeURIComponent(o)}`).join("&")}function j(){return Math.random().toString(36).slice(2,6)+Math.random().toString(36).slice(2,6)}function g(e,t){return`${$(t)}${e}${T(t)}`}function b(e,t){const n={forceEmbedLayout:!0};return t&&typeof t=="object"&&Object.assign(n,t),`${$(n)}${e}${T(n)}`}function $(e={}){return(typeof e.origin=="string"?e.origin:P).replace(/\/$/,"")}function v(e,t,n){if(!t||!e||!e.parentNode)throw new Error("Invalid Element");e.id&&(t.id=e.id),e.className&&(t.className=e.className),N(t,n),D(e,t,n),e.replaceWith(t)}function E(e){if(typeof e=="string"){const t=document.getElementById(e);if(!t)throw new Error(`Could not find element with id '${e}'`);return t}else if(e instanceof HTMLElement)return e;throw new Error(`Invalid element: ${e}`)}function w(e){return e&&e.newWindow===!1?"_self":"_blank"}function N(e,t={}){const n=Object.hasOwnProperty.call(t,"height")?`${t.height}`:"300",o=Object.hasOwnProperty.call(t,"width")?`${t.width}`:void 0;e.setAttribute("height",n),o?e.setAttribute("width",o):e.setAttribute("style","width:100%;")}function D(e,t,n={}){const o=e.allow?.split(";")?.map(s=>s.trim())??[];n.crossOriginIsolated&&!o.includes("cross-origin-isolated")&&o.push("cross-origin-isolated"),o.length>0&&(t.allow=o.join("; "))}class O{constructor(t){this.pending={},this.port=t,this.port.onmessage=this.messageListener.bind(this)}request({type:t,payload:n}){return new Promise((o,s)=>{const r=j();this.pending[r]={resolve:o,reject:s},this.port.postMessage({type:t,payload:{...n,__reqid:r}})})}messageListener(t){if(typeof t.data.payload?.__reqid!="string")return;const{type:n,payload:o}=t.data,{__reqid:s,__success:r,__error:i}=o;this.pending[s]&&(r?this.pending[s].resolve(this.cleanResult(o)):this.pending[s].reject(i?`${n}: ${i}`:n),delete this.pending[s])}cleanResult(t){const n={...t};return delete n.__reqid,delete n.__success,delete n.__error,Object.keys(n).length?n:null}}class M{constructor(t,n){this.editor={openFile:o=>this._rdc.request({type:"SDK_OPEN_FILE",payload:{path:o}}),setCurrentFile:o=>this._rdc.request({type:"SDK_SET_CURRENT_FILE",payload:{path:o}}),setTheme:o=>this._rdc.request({type:"SDK_SET_UI_THEME",payload:{theme:o}}),setView:o=>this._rdc.request({type:"SDK_SET_UI_VIEW",payload:{view:o}}),showSidebar:(o=!0)=>this._rdc.request({type:"SDK_TOGGLE_SIDEBAR",payload:{visible:o}})},this.preview={origin:"",getUrl:()=>this._rdc.request({type:"SDK_GET_PREVIEW_URL",payload:{}}).then(o=>o?.url??null),setUrl:(o="/")=>{if(typeof o!="string"||!o.startsWith("/"))throw new Error(`Invalid argument: expected a path starting with '/', got '${o}'`);return this._rdc.request({type:"SDK_SET_PREVIEW_URL",payload:{path:o}})}},this._rdc=new O(t),Object.defineProperty(this.preview,"origin",{value:typeof n.previewOrigin=="string"?n.previewOrigin:null,writable:!1})}applyFsDiff(t){const n=o=>o!==null&&typeof o=="object";if(!n(t)||!n(t.create))throw new Error("Invalid diff object: expected diff.create to be an object.");if(!Array.isArray(t.destroy))throw new Error("Invalid diff object: expected diff.destroy to be an array.");return this._rdc.request({type:"SDK_APPLY_FS_DIFF",payload:t})}getDependencies(){return this._rdc.request({type:"SDK_GET_DEPS_SNAPSHOT",payload:{}})}getFsSnapshot(){return this._rdc.request({type:"SDK_GET_FS_SNAPSHOT",payload:{}})}}const h=[];class U{constructor(t){this.id=j(),this.element=t,this.pending=new Promise((n,o)=>{const s=({data:c,ports:l})=>{c?.action==="SDK_INIT_SUCCESS"&&c.id===this.id&&(this.vm=new M(l[0],c.payload),n(this.vm),i())},r=()=>{this.element.contentWindow?.postMessage({action:"SDK_INIT",id:this.id},"*")};function i(){window.clearInterval(p),window.removeEventListener("message",s)}window.addEventListener("message",s),r();let a=0;const p=window.setInterval(()=>{if(this.vm){i();return}if(a>=20){i(),o("Timeout: Unable to establish a connection with the StackBlitz VM"),h.forEach((c,l)=>{c.id===this.id&&h.splice(l,1)});return}a++,r()},500)}),h.push(this)}}const q=e=>{const t=e instanceof Element?"element":"id";return h.find(n=>n[t]===e)??null};function F(e,t){const n=document.createElement("input");return n.type="hidden",n.name=e,n.value=t,n}function H(e){return e.replace(/\[/g,"%5B").replace(/\]/g,"%5D")}function k({template:e,title:t,description:n,dependencies:o,files:s,settings:r}){if(!S.includes(e)){const c=S.map(l=>`'${l}'`).join(", ");console.warn(`Unsupported project.template: must be one of ${c}`)}const i=[],a=(c,l,A="")=>{i.push(F(c,typeof l=="string"?l:A))};a("project[title]",t),typeof n=="string"&&n.length>0&&a("project[description]",n),a("project[template]",e,"javascript"),o&&(e==="node"?console.warn("Invalid project.dependencies: dependencies must be provided as a 'package.json' file when using the 'node' template."):a("project[dependencies]",JSON.stringify(o))),r&&a("project[settings]",JSON.stringify(r)),Object.entries(s).forEach(([c,l])=>{a(`project[files][${H(c)}]`,l)});const p=document.createElement("form");return p.method="POST",p.setAttribute("style","display:none!important;"),p.append(...i),p}function R(e,t){const n=k(e);return n.action=b("/run",t),n.id="sb_run",`<!doctype html>
<html>
...
</html>`}function W(e,t){const n=k(e);n.action=g("/run",t),n.target=w(t),document.body.appendChild(n),n.submit(),document.body.removeChild(n)}function f(e){return e?.contentWindow?(q(e)??new U(e)).pending:Promise.reject("Provided element is not an iframe.")}function V(e,t){W(e,t)}function z(e,t){const n=g(`/edit/${e}`,t),o=w(t);window.open(n,o)}function K(e,t){const n=g(`/github/${e}`,t),o=w(t);window.open(n,o)}function G(e,t,n){const o=E(e),s=R(t,n),r=document.createElement("iframe");return v(o,r,n),r.contentDocument?.write(s),f(r)}function J(e,t,n){const o=E(e),s=document.createElement("iframe");return s.src=b(`/edit/${t}`,n),v(o,s,n),f(s)}function X(e,t,n){const o=E(e),s=document.createElement("iframe");return s.src=b(`/github/${t}`,n),v(o,s,n),f(s)}const Y={connect:f,embedGithubProject:X,embedProject:G,embedProjectId:J,openGithubProject:K,openProject:V,openProjectId:z},Q=`// NOTICE!!! Initially embedded in our docs this JavaScript
...
`,m={cssCdn:"https://cdn.jsdelivr.net/npm/@ouds/web-orange@1.1.0/dist/css/ouds-web.min.css",cssBootstrapCdn:"https://cdn.jsdelivr.net/npm/@ouds/web-orange@1.1.0/dist/css/ouds-web-bootstrap.min.css",jsBundleCdn:"https://cdn.jsdelivr.net/npm/@ouds/web-common@1.1.0/dist/js/ouds-web.bundle.min.js",docsVersion:"1.1"};document.querySelectorAll(".btn-edit").forEach(e=>{e.addEventListener("click",t=>{const n=t.target.closest(".bd-code-snippet"),o=n.querySelector(".bd-example"),s=o.innerHTML,r=n.querySelector(".btn-edit").getAttribute("data-sb-js-snippet"),i=n.closest("[data-sb-css-bootstrap]"),a=Array.from(o.classList).join(" ");Z(s,r,a,i)})});const Z=(e,t,n,o)=>{const s=`<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8">
