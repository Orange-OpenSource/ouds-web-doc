...
`,m={cssCdn:"https://cdn.jsdelivr.net/npm/@ouds/web-orange@0.6.0/dist/css/ouds-web.min.css",cssBootstrapCdn:"https://cdn.jsdelivr.net/npm/@ouds/web-orange@0.6.0/dist/css/ouds-web-bootstrap.min.css",jsBundleCdn:"https://cdn.jsdelivr.net/npm/@ouds/web-common@0.6.0/dist/js/ouds-web.bundle.min.js",docsVersion:"0.6"};document.querySelectorAll(".btn-edit").forEach(e=>{e.addEventListener("click",t=>{const n=t.target.closest(".bd-code-snippet"),o=n.querySelector(".bd-example"),s=o.innerHTML,r=n.querySelector(".btn-edit").getAttribute("data-sb-js-snippet"),i=n.closest("[data-sb-css-bootstrap]"),a=Array.from(o.classList).join(" ");Z(s,r,a,i)})});const Z=(e,t,n,o)=>{const s=`<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8">
